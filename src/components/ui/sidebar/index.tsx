...
import { Home, Package, PanelBottom, ShoppingBag,ClipboardList,PackageSearch,User, Cog} from "lucide-react";
  ...
  return (
    <div className="flex w-full flex-col bg-muted/40">
      ...
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
        <header
          className="sticky top-0 z-30 flex h-14 items-center px-4 border-b bg-background gap-4 sm:static sm:px-6 sm:h-auto sm:border-0 
        sm:bg-transparent "
        >
          <Sheet>
